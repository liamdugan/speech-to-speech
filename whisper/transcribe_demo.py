...
'''
Code Adapted from https://github.com/davabase/whisper_real_time/blob/master/transcribe_demo.py
'''
...
def main():
    ...
    parser.add_argument("--translate", action='store_true',
                        help="Whether to use translation or not")
    parser.add_argument("--translation_language", default="japanese", 
                        help="The language to translate from", type=str)
    ...
    # If you want to search for microphones to use, uncomment the following line
